            ...
            <div class="col-xs-6">
                ...
                <form class="form-horizontal">
					  <div class="form-group">
					    ...
					    <div class="controls">
					      <input class="formColor" type="text" id="inputEmail" placeholder="Email">
					    </div>
					  </div>
                      <div class="form-group">
					    <label class="control-label" for="inputPassword">Password</label>
					    <div class="controls">
					      <input class="formColor" type="password" id="inputPassword" placeholder="Password">
					    </div>
					  </div>
                      <div class="form-group">
					    <label class="control-label" for="Username">Username</label>
					    <div class="controls">
					      <input class="formColor" type="text" id="Username" placeholder="Username">
					    </div>
					  </div>
                       <div class="form-group">
					    <label class="control-label" for="Fullname">Fullname</label>
					    <div class="controls">
					      <input class="formColor" type="text" id="Fullname" placeholder="Fullname">
					    </div>
					  </div>
